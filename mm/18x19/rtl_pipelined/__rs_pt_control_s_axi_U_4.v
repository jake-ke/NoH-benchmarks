...
) __rs_pt_kernel0_control_s_axi_WDATA_inst /**   Generated by RapidStream   **/ (
    .din  (WDATA),
    .dout (__rs_pt_WDATA)
);
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt_kernel0_control_s_axi_WREADY_inst /**   Generated by RapidStream   **/ (
    .din  (__rs_pt_WREADY),
    .dout (WREADY)
);
...
) __rs_pt_kernel0_control_s_axi_WSTRB_inst /**   Generated by RapidStream   **/ (
    .din  (WSTRB),
    .dout (__rs_pt_WSTRB)
);
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt_kernel0_control_s_axi_WVALID_inst /**   Generated by RapidStream   **/ (
    .din  (WVALID),
    .dout (__rs_pt_WVALID)
);
