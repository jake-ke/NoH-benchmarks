...
wire                      RS_FF_PP_BODY_8_clk;
wire [(DATA_WIDTH - 1):0] RS_FF_PP_BODY_8_if_din;
wire [(DATA_WIDTH - 1):0] RS_FF_PP_BODY_8_if_dout;
wire                      RS_FF_PP_BODY_9_clk;
wire [(DATA_WIDTH - 1):0] RS_FF_PP_BODY_9_if_din;
wire [(DATA_WIDTH - 1):0] RS_FF_PP_BODY_9_if_dout;
...
__rs_feed_forward_reg #(
    ...
    .if_dout (RS_FF_PP_BODY_8_if_dout)
);
...
__rs_feed_forward_reg #(
    ...
    .clk     (clk),
    .if_din  (RS_FF_PP_BODY_8_if_dout),
    .if_dout (RS_FF_PP_BODY_9_if_dout)
);
...
__rs_feed_forward_reg #(
    ...
    .clk     (clk),
    .if_din  (RS_FF_PP_BODY_9_if_dout),
    .if_dout (if_dout)
);

endmodule  // __rs_ff_pipeline_10