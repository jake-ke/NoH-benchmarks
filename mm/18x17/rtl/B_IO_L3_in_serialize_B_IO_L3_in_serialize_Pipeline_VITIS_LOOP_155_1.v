...
reg   [0:0] icmp_ln155_reg_282;
reg    ap_block_state2_io;
reg   [0:0] icmp_ln155_reg_282_pp0_iter4_reg;
...
reg   [0:0] icmp_ln158_reg_286;
reg   [0:0] icmp_ln158_reg_286_pp0_iter4_reg;
...
reg   [0:0] icmp_ln155_reg_282_pp0_iter1_reg;
reg   [0:0] icmp_ln155_reg_282_pp0_iter2_reg;
reg   [0:0] icmp_ln155_reg_282_pp0_iter3_reg;
wire   [0:0] icmp_ln158_fu_183_p2;
reg    ap_block_pp0_stage1_11001;
reg   [0:0] icmp_ln158_reg_286_pp0_iter1_reg;
reg   [0:0] icmp_ln158_reg_286_pp0_iter2_reg;
reg   [0:0] icmp_ln158_reg_286_pp0_iter3_reg;
reg   [511:0] B_addr_read_reg_301;
...
wire  signed [63:0] sext_ln158_fu_198_p1;
reg   [8:0] i_fu_76;
wire   [8:0] add_ln155_fu_143_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_i_1;
reg    ap_block_pp0_stage1_01001;
wire   [14:0] shl_ln158_1_fu_167_p3;
wire   [63:0] zext_ln158_fu_174_p1;
wire   [63:0] add_ln158_fu_178_p2;
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln158_reg_286_pp0_iter4_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (icmp_ln155_reg_282_pp0_iter4_reg == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        B_addr_read_reg_301 <= m_axi_B_RDATA;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001))) begin
        ...
        icmp_ln158_reg_286 <= icmp_ln158_fu_183_p2;
        icmp_ln158_reg_286_pp0_iter1_reg <= icmp_ln158_reg_286;
        icmp_ln158_reg_286_pp0_iter2_reg <= icmp_ln158_reg_286_pp0_iter1_reg;
        icmp_ln158_reg_286_pp0_iter3_reg <= icmp_ln158_reg_286_pp0_iter2_reg;
        icmp_ln158_reg_286_pp0_iter4_reg <= icmp_ln158_reg_286_pp0_iter3_reg;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        icmp_ln155_reg_282 <= icmp_ln155_fu_149_p2;
        icmp_ln155_reg_282_pp0_iter1_reg <= icmp_ln155_reg_282;
        icmp_ln155_reg_282_pp0_iter2_reg <= icmp_ln155_reg_282_pp0_iter1_reg;
        icmp_ln155_reg_282_pp0_iter3_reg <= icmp_ln155_reg_282_pp0_iter2_reg;
        icmp_ln155_reg_282_pp0_iter4_reg <= icmp_ln155_reg_282_pp0_iter3_reg;
        trunc_ln151_reg_321 <= trunc_ln151_fu_244_p1;
    end
end

always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1) & (icmp_ln155_reg_282 == 1'd0))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln158_reg_286_pp0_iter4_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (icmp_ln155_reg_282_pp0_iter4_reg == 1'd0)) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1) & (icmp_ln155_reg_282_pp0_iter4_reg == 1'd0)))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_subdone) & (icmp_ln155_reg_282 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln155_reg_282 == 1'd0))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter5 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_predicate_op60_read_state11 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001)) | ((ap_enable_reg_pp0_iter4 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'b0 == ap_block_pp0_stage1_11001) & (icmp_ln155_reg_282_pp0_iter4_reg == 1'd0)))) begin
        m_axi_B_RREADY = 1'b1;
    end else begin
        m_axi_B_RREADY = 1'b0;
    end
...
assign add_ln158_fu_178_p2 = (zext_ln158_fu_174_p1 + B_offset);
...
always @ (*) begin
    ap_block_state10_pp0_stage1_iter4 = ((m_axi_B_RVALID == 1'b0) & (icmp_ln155_reg_282_pp0_iter4_reg == 1'd0));
end

always @ (*) begin
    ap_block_state11_pp0_stage0_iter5 = ((m_axi_B_RVALID == 1'b0) & (ap_predicate_op60_read_state11 == 1'b1));
end
...
always @ (*) begin
    ap_block_state2_io = ((m_axi_B_ARREADY == 1'b0) & (icmp_ln155_reg_282 == 1'd0));
end
...
always @ (*) begin
    ap_predicate_op60_read_state11 = ((icmp_ln158_reg_286_pp0_iter4_reg == 1'd1) & (icmp_ln155_reg_282_pp0_iter4_reg == 1'd0));
end

assign fifo_B_local_out_din = trunc_ln151_reg_321;

assign grp_fu_238_p0 = {{ap_phi_reg_pp0_iter5_empty_24_reg_110}, {B_addr_read_reg_301}};

assign grp_fu_238_p1 = shl_ln_fu_227_p3;

assign icmp_ln155_fu_149_p2 = ((ap_sig_allocacmp_i_1 == 9'd272) ? 1'b1 : 1'b0);

assign icmp_ln158_fu_183_p2 = ((empty != 6'd0) ? 1'b1 : 1'b0);

assign m_axi_B_ARADDR = sext_ln158_fu_198_p1;
...
assign m_axi_B_ARLEN = ((icmp_ln158_fu_183_p2[0:0] == 1'b1) ? 32'd2 : 32'd1);
...
assign sext_ln158_fu_198_p1 = $signed(trunc_ln1_fu_188_p4);

assign shl_ln158_1_fu_167_p3 = {{i_1_reg_277}, {6'd0}};

assign shl_ln_fu_227_p3 = {{empty}, {3'd0}};

assign trunc_ln151_fu_244_p1 = grp_fu_238_p2[511:0];

assign trunc_ln1_fu_188_p4 = {{add_ln158_fu_178_p2[63:6]}};

assign zext_ln158_fu_174_p1 = shl_ln158_1_fu_167_p3;

endmodule //B_IO_L3_in_serialize_B_IO_L3_in_serialize_Pipeline_VITIS_LOOP_155_1
