...
wire   [0:0] icmp_ln213_fu_236_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln213_fu_242_p1;
reg   [13:0] i_fu_52;
wire   [13:0] add_ln213_fu_226_p2;
wire    ap_loop_init;
reg   [13:0] ap_sig_allocacmp_i_3;
wire   [22:0] zext_ln213_1_fu_232_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln213_fu_236_p2 == 1'd1)) begin
            i_fu_52 <= add_ln213_fu_226_p2;
...
always @ (*) begin
    if (((icmp_ln213_fu_236_p2 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((icmp_ln213_fu_236_p2 == 1'd1) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        local_C_1_we1 = 1'b1;
    end else begin
        local_C_1_we1 = 1'b0;
    end
...
assign add_ln213_fu_226_p2 = (ap_sig_allocacmp_i_3 + 14'd1);
assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = (ap_start_int == 1'b0);
end
assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage0;
assign icmp_ln213_fu_236_p2 = (($signed(zext_ln213_1_fu_232_p1) < $signed(select_ln202_1)) ? 1'b1 : 1'b0);
assign local_C_1_address1 = zext_ln213_fu_242_p1;
assign local_C_1_d1 = 64'd0;
assign local_C_2_address1 = zext_ln213_fu_242_p1;
assign local_C_2_d1 = 64'd0;
assign local_C_3_address1 = zext_ln213_fu_242_p1;
assign local_C_3_d1 = 64'd0;
assign local_C_4_address1 = zext_ln213_fu_242_p1;
assign local_C_4_d1 = 64'd0;
assign local_C_5_address1 = zext_ln213_fu_242_p1;
assign local_C_5_d1 = 64'd0;
assign local_C_6_address1 = zext_ln213_fu_242_p1;
assign local_C_6_d1 = 64'd0;
assign local_C_7_address1 = zext_ln213_fu_242_p1;
assign local_C_7_d1 = 64'd0;
assign local_C_address1 = zext_ln213_fu_242_p1;
assign local_C_d1 = 64'd0;
assign zext_ln213_1_fu_232_p1 = ap_sig_allocacmp_i_3;
assign zext_ln213_fu_242_p1 = ap_sig_allocacmp_i_3;
endmodule