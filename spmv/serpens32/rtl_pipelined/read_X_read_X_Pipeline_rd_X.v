...
module read_X_read_X_Pipeline_rd_X (
        ...
        mul_cast,
        vec_X_read_addr_s_din,
        vec_X_read_addr_s_full_n,
        vec_X_read_addr_s_write,
        vec_X_read_addr_offset_load,
        tmp_1_out_i,
        tmp_1_out_o,
        tmp_1_out_o_ap_vld
);
...
input  [28:0] mul_cast;
output  [63:0] vec_X_read_addr_s_din;
input   vec_X_read_addr_s_full_n;
output   vec_X_read_addr_s_write;
input  [63:0] vec_X_read_addr_offset_load;
...
wire   [31:0] or_ln197_1_fu_527_p2;
...
wire   [31:0] or_ln197_2_fu_565_p2;
...
wire   [31:0] or_ln197_3_fu_603_p2;
...
wire   [31:0] or_ln197_4_fu_641_p2;
...
wire   [31:0] or_ln197_5_fu_679_p2;
...
wire   [31:0] or_ln197_6_fu_717_p2;
...
wire   [0:0] icmp_ln201_fu_920_p2;
wire   [0:0] and_ln201_fu_926_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            cnt_fu_118 <= 32'd0;
        end else if (((icmp_ln181_fu_281_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        sext_ln173_cast_reg_1019 <= sext_ln173_cast_fu_222_p1;
    end
end
always @ (*) begin
    if (((icmp_ln181_fu_281_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((icmp_ln181_fu_281_p2 == 1'd1)) begin
        if ((1'd0 == and_ln193_fu_353_p2)) begin
            ap_phi_mux_cnt_1_phi_fu_195_p4 = cnt_fu_118;
        end else if ((1'd1 == and_ln193_fu_353_p2)) begin
...
always @ (*) begin
    if ((icmp_ln181_fu_281_p2 == 1'd1)) begin
        if ((1'd0 == and_ln201_fu_926_p2)) begin
            ap_phi_mux_cnt_2_phi_fu_204_p4 = ap_phi_mux_cnt_1_phi_fu_195_p4;
        end else if ((1'd1 == and_ln201_fu_926_p2)) begin
...
always @ (*) begin
    if (((1'd1 == and_ln193_fu_353_p2) & (icmp_ln181_fu_281_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'd1 == and_ln201_fu_926_p2) & (fifo_X_full_n == 1'b1) & (icmp_ln181_fu_281_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        fifo_X_write = 1'b1;
    end else begin
        fifo_X_write = 1'b0;
    end
...
always @ (*) begin
    if (((1'd1 == and_ln193_fu_353_p2) & (icmp_ln181_fu_281_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'd1 == and_ln188_fu_291_p2) & (vec_X_read_addr_s_full_n == 1'b1) & (icmp_ln181_fu_281_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        vec_X_read_addr_s_write = 1'b1;
    end else begin
        vec_X_read_addr_s_write = 1'b0;
    end
end
always @ (*) begin
    if (((1'd1 == and_ln193_fu_353_p2) & (vec_X_read_data_s_empty_n == 1'b1) & (icmp_ln181_fu_281_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign and_ln188_fu_291_p1 = vec_X_read_addr_s_full_n;
assign and_ln188_fu_291_p2 = (icmp_ln188_fu_286_p2 & and_ln188_fu_291_p1);
assign and_ln193_fu_353_p2 = (tmp_3_nbreadreq_fu_163_p3 & icmp_ln193_fu_347_p2);
assign and_ln201_fu_926_p1 = fifo_X_full_n;
assign and_ln201_fu_926_p2 = (icmp_ln201_fu_920_p2 & and_ln201_fu_926_p1);
...
always @ (*) begin
    ap_condition_620 = ((1'd1 == and_ln188_fu_291_p2) & (icmp_ln181_fu_281_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
always @ (*) begin
    ap_condition_623 = ((1'd1 == and_ln201_fu_926_p2) & (icmp_ln181_fu_281_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign elem_val_1_fu_377_p4 = {{vec_X_read_data_s_dout[63:32]}};
assign elem_val_fu_373_p1 = vec_X_read_data_s_dout[31:0];
...
assign icmp_ln181_fu_281_p2 = (($signed(i_resp_fu_122) < $signed(sext_ln173_cast_reg_1019)) ? 1'b1 : 1'b0);
assign icmp_ln188_fu_286_p2 = (($signed(i_req_fu_126) < $signed(mul_cast_cast_reg_1014)) ? 1'b1 : 1'b0);
assign icmp_ln193_fu_347_p2 = (($signed(tmp_1_fu_337_p4) < $signed(31'd1)) ? 1'b1 : 1'b0);
assign icmp_ln201_fu_920_p2 = ((ap_phi_mux_cnt_1_phi_fu_195_p4 == 32'd2) ? 1'b1 : 1'b0);
assign lshr_ln78_1_fu_397_p4 = {{vec_X_read_data_s_dout[127:96]}};
assign lshr_ln78_2_fu_407_p4 = {{vec_X_read_data_s_dout[159:128]}};
assign lshr_ln78_3_fu_417_p4 = {{vec_X_read_data_s_dout[191:160]}};
assign lshr_ln78_4_fu_427_p4 = {{vec_X_read_data_s_dout[223:192]}};
assign lshr_ln78_5_fu_437_p4 = {{vec_X_read_data_s_dout[255:224]}};
assign lshr_ln_fu_387_p4 = {{vec_X_read_data_s_dout[95:64]}};
assign mul_cast_cast_fu_218_p1 = $signed(mul_cast);
assign or_ln197_1_fu_527_p2 = (empty_16_fu_451_p2 | 32'd2);
assign or_ln197_2_fu_565_p2 = (empty_16_fu_451_p2 | 32'd3);
assign or_ln197_3_fu_603_p2 = (empty_16_fu_451_p2 | 32'd4);
assign or_ln197_4_fu_641_p2 = (empty_16_fu_451_p2 | 32'd5);
assign or_ln197_5_fu_679_p2 = (empty_16_fu_451_p2 | 32'd6);
assign or_ln197_6_fu_717_p2 = (empty_16_fu_451_p2 | 32'd7);
assign or_ln197_fu_489_p2 = (empty_16_fu_451_p2 | 32'd1);
...
assign sext_ln173_cast_fu_222_p1 = $signed(sext_ln173);
...
assign shl_ln54_1_fu_495_p3 = {{or_ln197_fu_489_p2}, {5'd0}};
assign shl_ln54_2_fu_533_p3 = {{or_ln197_1_fu_527_p2}, {5'd0}};
assign shl_ln54_3_fu_571_p3 = {{or_ln197_2_fu_565_p2}, {5'd0}};
assign shl_ln54_4_fu_609_p3 = {{or_ln197_3_fu_603_p2}, {5'd0}};
assign shl_ln54_5_fu_647_p3 = {{or_ln197_4_fu_641_p2}, {5'd0}};
assign shl_ln54_6_fu_685_p3 = {{or_ln197_5_fu_679_p2}, {5'd0}};
assign shl_ln54_7_fu_723_p3 = {{or_ln197_6_fu_717_p2}, {5'd0}};
...
assign tmp_3_nbreadreq_fu_163_p3 = vec_X_read_data_s_empty_n;
assign vec_X_read_addr_s_din = ($signed(vec_X_read_addr_offset_load) + $signed(sext_ln25_fu_305_p1));
