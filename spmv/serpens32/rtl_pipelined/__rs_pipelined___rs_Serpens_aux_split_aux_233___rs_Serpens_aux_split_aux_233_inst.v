...
module __rs_pipelined___rs_Serpens_aux_split_aux_233___rs_Serpens_aux_split_aux_233_inst #(
...
wire [31:0] __rs_pipelined___tapa_fsm_unit_read_A_6___NUM_A_LEN__q0;
wire [31:0] __rs_pipelined___tapa_fsm_unit_read_A_6___P_N__q0;
wire [63:0] __rs_pipelined___tapa_fsm_unit_read_A_6___edge_list_ch_6__q0;
wire        __rs_pipelined___tapa_fsm_unit_read_A_6__ap_done;
wire        __rs_pipelined___tapa_fsm_unit_read_A_6__ap_idle;
wire        __rs_pipelined___tapa_fsm_unit_read_A_6__ap_ready;
wire        __rs_pipelined___tapa_fsm_unit_read_A_6__ap_start;
...
__rs_Serpens_aux_split_aux_233 #(
    ...
    .__tapa_fsm_unit_read_A_6___NUM_A_LEN__q0      (__rs_pipelined___tapa_fsm_unit_read_A_6___NUM_A_LEN__q0),
    .__tapa_fsm_unit_read_A_6___P_N__q0            (__rs_pipelined___tapa_fsm_unit_read_A_6___P_N__q0),
    .__tapa_fsm_unit_read_A_6___edge_list_ch_6__q0 (__rs_pipelined___tapa_fsm_unit_read_A_6___edge_list_ch_6__q0),
    .__tapa_fsm_unit_read_A_6__ap_done             (__rs_pipelined___tapa_fsm_unit_read_A_6__ap_done),
    .__tapa_fsm_unit_read_A_6__ap_idle             (__rs_pipelined___tapa_fsm_unit_read_A_6__ap_idle),
    .__tapa_fsm_unit_read_A_6__ap_ready            (__rs_pipelined___tapa_fsm_unit_read_A_6__ap_ready),
    .__tapa_fsm_unit_read_A_6__ap_start            (__rs_pipelined___tapa_fsm_unit_read_A_6__ap_start),
    .ap_clk                                        (ap_clk),
    .ap_rst_n                                      (ap_rst_n),
...
__rs_ap_ctrl_start_ready_pipeline_2 #(
    ...
    .if_empty_n (__rs_pipelined___tapa_fsm_unit_read_A_6__ap_start),
    .if_full_n  (__tapa_fsm_unit_read_A_6__ap_ready),
    .if_read    (__rs_pipelined___tapa_fsm_unit_read_A_6__ap_ready),
...
__rs_ff_pipeline_2 #(
    ...
    .if_dout ({ __rs_pipelined___tapa_fsm_unit_read_A_6___NUM_A_LEN__q0 , __rs_pipelined___tapa_fsm_unit_read_A_6___P_N__q0 , __rs_pipelined___tapa_fsm_unit_read_A_6___edge_list_ch_6__q0 })
);
...
__rs_ff_pipeline_2 #(
    ...
    .clk     (__tapa_fsm_unit_ap_clk),
    .if_din  ({ __rs_pipelined___tapa_fsm_unit_read_A_6__ap_done , __rs_pipelined___tapa_fsm_unit_read_A_6__ap_idle }),
    .if_dout ({ __tapa_fsm_unit_read_A_6__ap_done , __tapa_fsm_unit_read_A_6__ap_idle })
);

endmodule  // __rs_pipelined___rs_Serpens_aux_split_aux_233___rs_Serpens_aux_split_aux_233_inst