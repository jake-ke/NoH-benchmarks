...
localparam
    ...
    ADDR_VEC_X_DATA_0           = 10'h1fc,
    ADDR_VEC_X_DATA_1           = 10'h200,
    ADDR_VEC_X_CTRL             = 10'h204,
    ADDR_VEC_Y_DATA_0           = 10'h208,
    ADDR_VEC_Y_DATA_1           = 10'h20c,
    ADDR_VEC_Y_CTRL             = 10'h210,
    ADDR_VEC_Y_OUT_DATA_0       = 10'h214,
    ADDR_VEC_Y_OUT_DATA_1       = 10'h218,
    ADDR_VEC_Y_OUT_CTRL         = 10'h21c,
    ADDR_NUM_ITE_DATA_0         = 10'h220,
    ADDR_NUM_ITE_CTRL           = 10'h224,
    ADDR_NUM_A_LEN_DATA_0       = 10'h228,
    ADDR_NUM_A_LEN_CTRL         = 10'h22c,
    ADDR_M_DATA_0               = 10'h230,
    ADDR_M_CTRL                 = 10'h234,
    ADDR_K_DATA_0               = 10'h238,
    ADDR_K_CTRL                 = 10'h23c,
    ADDR_P_N_DATA_0             = 10'h240,
    ADDR_P_N_CTRL               = 10'h244,
    ADDR_ALPHA_U_DATA_0         = 10'h248,
    ADDR_ALPHA_U_CTRL           = 10'h24c,
    ADDR_BETA_U_DATA_0          = 10'h250,
    ADDR_BETA_U_CTRL            = 10'h254,
    WRIDLE                      = 2'd0,
    WRDATA                      = 2'd1,
    WRRESP                      = 2'd2,
    WRRESET                     = 2'd3,
