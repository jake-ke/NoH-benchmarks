...
(* CORE_GENERATION_INFO="FloatvMultConst_FloatvMultConst,hls_ip_2023_2_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvh1582-vsva3697-2MP-e-S,HLS_INPUT_CLOCK=3.330000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.089000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2366,HLS_SYN_LUT=1032,HLS_VERSION=2023_2_2}" *)
...
reg   [31:0] num_ite_Y_reg_173;
wire   [31:0] empty_78_fu_154_p1;
reg   [31:0] empty_78_reg_178;
...
wire   [0:0] icmp_ln208_fu_110_p2;
wire   [31:0] add_ln209_fu_125_p2;
wire  signed [27:0] trunc_ln_fu_131_p4;
reg   [4:0] ap_NS_fsm;
...
FloatvMultConst_FloatvMultConst_Pipeline_cc grp_FloatvMultConst_Pipeline_cc_fu_92(
    ...
    .empty(empty_78_reg_178)
);

FloatvMultConst_mul_32s_28s_32_3_1 #(
    .ID( 1 ),
    .NUM_STAGE( 3 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 28 ),
    .dout_WIDTH( 32 ))
mul_32s_28s_32_3_1_U22(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .din0(grp_fu_102_p0),
    .din1(trunc_ln_fu_131_p4),
    .ce(1'b1),
    .dout(grp_fu_102_p2)
);
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        empty_78_reg_178 <= empty_78_fu_154_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        num_ite_Y_reg_173 <= grp_fu_102_p2;
    end
end
...
assign add_ln209_fu_125_p2 = (M + 32'd15);
...
assign empty_78_fu_154_p1 = alpha_u;
...
assign grp_fu_102_p0 = ((icmp_ln208_fu_110_p2[0:0] == 1'b1) ? 32'd1 : P_N);

assign icmp_ln208_fu_110_p2 = ((P_N == 32'd0) ? 1'b1 : 1'b0);

assign trunc_ln_fu_131_p4 = {{add_ln209_fu_125_p2[31:4]}};
