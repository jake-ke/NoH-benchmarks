...
module __rs_pt___rs_pt_edge_list_ptr__m_axi_3_edge_list_ptr__m_axi_inst_0 #(
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt___rs_pt_edge_list_ptr__m_axi_3_m_axi_BID_inst /**   Generated by RapidStream   **/ (
    .din  (m_axi_BID),
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt___rs_pt_edge_list_ptr__m_axi_3_m_axi_BREADY_inst /**   Generated by RapidStream   **/ (
...
__rs_pass_through #(
    .WIDTH (2)
) __rs_pt___rs_pt_edge_list_ptr__m_axi_3_m_axi_BRESP_inst /**   Generated by RapidStream   **/ (
    .din  (m_axi_BRESP),
...
__rs_pass_through #(
    .WIDTH (1)
) __rs_pt___rs_pt_edge_list_ptr__m_axi_3_m_axi_BVALID_inst /**   Generated by RapidStream   **/ (
    .din  (m_axi_BVALID),
    .dout (__rs_pt_m_axi_BVALID)
);

endmodule  // __rs_pt___rs_pt_edge_list_ptr__m_axi_3_edge_list_ptr__m_axi_inst_0