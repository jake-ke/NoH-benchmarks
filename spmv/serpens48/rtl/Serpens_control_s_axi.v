...
localparam
    ...
    ADDR_VEC_X_DATA_0           = 10'h25c,
    ADDR_VEC_X_DATA_1           = 10'h260,
    ADDR_VEC_X_CTRL             = 10'h264,
    ADDR_VEC_Y_DATA_0           = 10'h268,
    ADDR_VEC_Y_DATA_1           = 10'h26c,
    ADDR_VEC_Y_CTRL             = 10'h270,
    ADDR_VEC_Y_OUT_DATA_0       = 10'h274,
    ADDR_VEC_Y_OUT_DATA_1       = 10'h278,
    ADDR_VEC_Y_OUT_CTRL         = 10'h27c,
    ADDR_NUM_ITE_DATA_0         = 10'h280,
    ADDR_NUM_ITE_CTRL           = 10'h284,
    ADDR_NUM_A_LEN_DATA_0       = 10'h288,
    ADDR_NUM_A_LEN_CTRL         = 10'h28c,
    ADDR_M_DATA_0               = 10'h290,
    ADDR_M_CTRL                 = 10'h294,
    ADDR_K_DATA_0               = 10'h298,
    ADDR_K_CTRL                 = 10'h29c,
    ADDR_P_N_DATA_0             = 10'h2a0,
    ADDR_P_N_CTRL               = 10'h2a4,
    ADDR_ALPHA_U_DATA_0         = 10'h2a8,
    ADDR_ALPHA_U_CTRL           = 10'h2ac,
    ADDR_BETA_U_DATA_0          = 10'h2b0,
    ADDR_BETA_U_CTRL            = 10'h2b4,
    WRIDLE                      = 2'd0,
    WRDATA                      = 2'd1,
    WRRESP                      = 2'd2,
    WRRESET                     = 2'd3,
