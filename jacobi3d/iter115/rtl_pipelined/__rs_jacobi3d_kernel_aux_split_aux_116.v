...
// ==================================================
`timescale 1 ns / 1 ps
module __rs_jacobi3d_kernel_aux_split_aux_116 #(
...
assign Module2Func_94_fifo_ld_0_peek_dout = from_t1_iter95_to_t1_iter96_if_dout;
assign Module2Func_94_fifo_ld_0_peek_empty_n = from_t1_iter95_to_t1_iter96_if_empty_n;
assign Module2Func_94_fifo_ld_0_s_dout = from_t1_iter95_to_t1_iter96_if_dout;
assign Module2Func_94_fifo_ld_0_s_empty_n = from_t1_iter95_to_t1_iter96_if_empty_n;
assign from_t1_iter95_to_t1_iter96_if_read = Module2Func_94_fifo_ld_0_s_read;
endmodule
