...
module __rs_pipelined_Module0Func_Module0Func_0 #(
    ...
    input wire          ap_rst_n,
    input wire          ap_start,
    input wire  [512:0] dram_t1_bank_0_fifo_peek_dout,
    input wire          dram_t1_bank_0_fifo_peek_empty_n,
    output wire         dram_t1_bank_0_fifo_peek_read,
    input wire  [512:0] dram_t1_bank_0_fifo_s_dout,
    input wire          dram_t1_bank_0_fifo_s_empty_n,
    output wire         dram_t1_bank_0_fifo_s_read,
...
Module0Func _ /**   Module0Func_0   **/ (
    ...
    .dram_t1_bank_0_fifo_peek_read    (dram_t1_bank_0_fifo_peek_read),
    .dram_t1_bank_0_fifo_s_dout       (dram_t1_bank_0_fifo_s_dout),
    .dram_t1_bank_0_fifo_s_empty_n    (dram_t1_bank_0_fifo_s_empty_n),
    .dram_t1_bank_0_fifo_s_read       (dram_t1_bank_0_fifo_s_read),
...
endmodule  // __rs_pipelined_Module0Func_Module0Func_0