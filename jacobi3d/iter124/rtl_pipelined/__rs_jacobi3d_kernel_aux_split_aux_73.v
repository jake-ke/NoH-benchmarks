...
// ==================================================
`timescale 1 ns / 1 ps
module __rs_jacobi3d_kernel_aux_split_aux_73 #(
...
assign Module2Func_47_fifo_ld_0_peek_dout = from_t1_iter48_to_t1_iter49_if_dout;
assign Module2Func_47_fifo_ld_0_peek_empty_n = from_t1_iter48_to_t1_iter49_if_empty_n;
assign Module2Func_47_fifo_ld_0_s_dout = from_t1_iter48_to_t1_iter49_if_dout;
assign Module2Func_47_fifo_ld_0_s_empty_n = from_t1_iter48_to_t1_iter49_if_empty_n;
assign from_t1_iter48_to_t1_iter49_if_read = Module2Func_47_fifo_ld_0_s_read;
endmodule
