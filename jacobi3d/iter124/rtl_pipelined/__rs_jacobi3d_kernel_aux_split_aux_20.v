...
// ==================================================
`timescale 1 ns / 1 ps
module __rs_jacobi3d_kernel_aux_split_aux_20 #(
...
assign Module2Func_10_fifo_ld_0_peek_dout = from_t1_iter11_to_t1_iter12_if_dout;
assign Module2Func_10_fifo_ld_0_peek_empty_n = from_t1_iter11_to_t1_iter12_if_empty_n;
assign Module2Func_10_fifo_ld_0_s_dout = from_t1_iter11_to_t1_iter12_if_dout;
assign Module2Func_10_fifo_ld_0_s_empty_n = from_t1_iter11_to_t1_iter12_if_empty_n;
assign from_t1_iter11_to_t1_iter12_if_read = Module2Func_10_fifo_ld_0_s_read;
endmodule
