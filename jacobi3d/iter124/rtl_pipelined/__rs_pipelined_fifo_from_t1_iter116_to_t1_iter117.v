...
module __rs_pipelined_fifo_from_t1_iter116_to_t1_iter117 #(
...
fifo #(
    ...
    .DEPTH      (DEPTH)
) _ /**   from_t1_iter116_to_t1_iter117   **/ (
    .clk         (clk),
    .if_din      (if_din),
    .if_dout     (if_dout),
...
(* RS_ROUTE="SLOT_X1Y2_TO_SLOT_X1Y2,SLOT_X1Y1_TO_SLOT_X1Y1,SLOT_X1Y0_TO_SLOT_X1Y0,SLOT_X0Y0_TO_SLOT_X0Y0,SLOT_X0Y1_TO_SLOT_X0Y1" *)
__rs_ff_pipeline_8 #(
    .BODY_LEVEL      (8),
    .DATA_WIDTH      (1),
    .HEAD_LEVEL      (1),
...
endmodule  // __rs_pipelined_fifo_from_t1_iter116_to_t1_iter117