...
module __rs_pipelined_async_mmap_bank_1_t0__m_axi #(
...
wire [(AddrWidth - 1):0] __rs_pipelined_read_addr_din;
wire                     __rs_pipelined_read_addr_full_n;
wire                     __rs_pipelined_read_addr_write;
...
async_mmap #(
    ...
    .read_addr_din      (__rs_pipelined_read_addr_din),
    .read_addr_full_n   (__rs_pipelined_read_addr_full_n),
    .read_addr_write    (__rs_pipelined_read_addr_write),
...
__rs_hs_pipeline_6 #(
    ...
    .if_dout    ({ __rs_pipelined_read_addr_din }),
    .if_empty_n (__rs_pipelined_read_addr_write),
    .if_full_n  (read_addr_full_n),
    .if_read    (__rs_pipelined_read_addr_full_n),
    .if_write   (read_addr_write),
    .reset      (1'b0)
);

endmodule  // __rs_pipelined_async_mmap_bank_1_t0__m_axi