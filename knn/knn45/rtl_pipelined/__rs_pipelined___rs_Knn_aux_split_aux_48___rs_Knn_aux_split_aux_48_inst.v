...
__rs_Knn_aux_split_aux_48 #(
    ...
    .__tapa_fsm_unit_krnl_output_dist_id_0___L3_out_dist__q0 (__tapa_fsm_unit_krnl_output_dist_id_0___L3_out_dist__q0),
    .__tapa_fsm_unit_krnl_output_dist_id_0___L3_out_id__q0   (__tapa_fsm_unit_krnl_output_dist_id_0___L3_out_id__q0),
    .__tapa_fsm_unit_krnl_output_dist_id_0__ap_done          (__tapa_fsm_unit_krnl_output_dist_id_0__ap_done),
    .__tapa_fsm_unit_krnl_output_dist_id_0__ap_idle          (__tapa_fsm_unit_krnl_output_dist_id_0__ap_idle),
    .__tapa_fsm_unit_krnl_output_dist_id_0__ap_ready         (__tapa_fsm_unit_krnl_output_dist_id_0__ap_ready),
    .__tapa_fsm_unit_krnl_output_dist_id_0__ap_start         (__tapa_fsm_unit_krnl_output_dist_id_0__ap_start),
    .ap_clk                                                  (ap_clk),
    .ap_rst_n                                                (__rs_pipelined_ap_rst_n),
    .krnl_output_dist_id_0_ap_clk                            (krnl_output_dist_id_0_ap_clk),
    .krnl_output_dist_id_0_ap_done                           (krnl_output_dist_id_0_ap_done),
    .krnl_output_dist_id_0_ap_idle                           (krnl_output_dist_id_0_ap_idle),
    .krnl_output_dist_id_0_ap_ready                          (krnl_output_dist_id_0_ap_ready),
    .krnl_output_dist_id_0_ap_rst_n                          (krnl_output_dist_id_0_ap_rst_n),
    .krnl_output_dist_id_0_ap_start                          (krnl_output_dist_id_0_ap_start),
    .krnl_output_dist_id_0_output_knnDist_read_addr_offset   (krnl_output_dist_id_0_output_knnDist_read_addr_offset),
    .krnl_output_dist_id_0_output_knnDist_write_addr_offset  (krnl_output_dist_id_0_output_knnDist_write_addr_offset),
    .krnl_output_dist_id_0_output_knnId_read_addr_offset     (krnl_output_dist_id_0_output_knnId_read_addr_offset),
    .krnl_output_dist_id_0_output_knnId_write_addr_offset    (krnl_output_dist_id_0_output_knnId_write_addr_offset)
);
