...
module krnl_partialKnn_wrapper_30_load_Pipeline_VITIS_LOOP_55_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] select_ln58_fu_251_p3;
...
wire   [0:0] select_ln58_fu_251_p0;
wire   [31:0] add_ln59_fu_245_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if ((ap_loop_init == 1'b1)) begin
            ...
            i_req_fu_64 <= select_ln58_fu_251_p3;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        icmp_ln55_reg_317 <= icmp_ln55_fu_162_p2;
        tmp_1_reg_321 <= tmp_1_nbreadreq_fu_80_p3;
        zext_ln55_cast_reg_307[12 : 0] <= zext_ln55_cast_fu_118_p1[12 : 0];
    end
end

always @ (*) begin
    if (((icmp_ln55_fu_162_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_1_reg_321 == 1'd1) & (icmp_ln55_reg_317 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        local_SP_we0 = 1'b1;
    end else begin
        local_SP_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln55_reg_317 == 1'd1) & (searchSpace_0_read_addr_s_full_n == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln58_fu_217_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((tmp_1_nbreadreq_fu_80_p3 == 1'd1) & (searchSpace_0_read_data_s_empty_n == 1'b1) & (icmp_ln55_fu_162_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign add_ln59_fu_245_p2 = (i_req_fu_64 + 32'd1);

assign addr_fu_202_p2 = (i_req_fu_64 + zext_ln55_cast_reg_307);
...
always @ (*) begin
    ap_condition_224 = ((icmp_ln55_reg_317 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln58_fu_217_p2 == 1'd1));
end

always @ (*) begin
    ap_condition_227 = ((tmp_1_nbreadreq_fu_80_p3 == 1'd1) & (icmp_ln55_fu_162_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1));
end
...
assign icmp_ln55_fu_162_p2 = (($signed(tmp_4_fu_152_p4) < $signed(21'd1)) ? 1'b1 : 1'b0);

assign icmp_ln58_fu_217_p2 = (($signed(tmp_5_fu_207_p4) < $signed(21'd1)) ? 1'b1 : 1'b0);

assign local_SP_address0 = zext_ln62_fu_271_p1;
...
assign select_ln58_fu_251_p0 = searchSpace_0_read_addr_s_full_n;

assign select_ln58_fu_251_p3 = ((select_ln58_fu_251_p0[0:0] == 1'b1) ? add_ln59_fu_245_p2 : i_req_fu_64);
...
assign zext_ln55_cast_fu_118_p1 = zext_ln55;

assign zext_ln62_fu_271_p1 = i_resp_1_reg_312;

always @ (posedge ap_clk) begin
    zext_ln55_cast_reg_307[31:13] <= 19'b0000000000000000000;
end

endmodule //krnl_partialKnn_wrapper_30_load_Pipeline_VITIS_LOOP_55_1
