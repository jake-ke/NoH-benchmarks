...
wire   [3:0] trunc_ln680_fu_998_p1;
reg   [3:0] trunc_ln680_reg_1606;
wire    ap_CS_fsm_state2;
wire   [3:0] trunc_ln680_1_fu_1003_p1;
reg   [3:0] trunc_ln680_1_reg_1611;
wire   [3:0] trunc_ln680_2_fu_1008_p1;
reg   [3:0] trunc_ln680_2_reg_1616;
wire    grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start;
wire    grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_done;
wire    grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_idle;
wire    grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_ready;
wire   [1:0] grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_idx_out;
wire    grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_idx_out_ap_vld;
wire   [31:0] grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;
wire    grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out_ap_vld;
reg    grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start_reg;
wire   [0:0] tmp_5_fu_981_p3;
wire    ap_CS_fsm_state3;
reg   [1:0] min_idx_loc_fu_246;
reg   [4:0] i_fu_226;
wire   [4:0] add_ln680_fu_1227_p2;
...
initial begin
#0 ap_CS_fsm = 4'd1;
#0 grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start_reg = 1'b0;
#0 i_fu_226 = 5'd0;
#0 idx_fu_230 = 32'd0;
...
krnl_globalSort_L1_L2_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3 grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start),
    .ap_done(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_done),
    .ap_idle(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_idle),
    .ap_ready(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_ready),
    .empty_8(trunc_ln680_2_reg_1616),
    .empty_9(trunc_ln680_1_reg_1611),
    .empty(trunc_ln680_reg_1606),
    ...
    .min_idx_out(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_idx_out),
    .min_idx_out_ap_vld(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_idx_out_ap_vld),
    .min_value_out(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out),
    .min_value_out_ap_vld(grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out_ap_vld)
);
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start_reg <= 1'b0;
    end else begin
        if (((tmp_5_fu_981_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
            grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start_reg <= 1'b1;
        end else if ((grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_ready == 1'b1)) begin
            grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_idx_out_ap_vld == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
        min_idx_loc_fu_246 <= grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_idx_out;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        trunc_ln680_1_reg_1611 <= trunc_ln680_1_fu_1003_p1;
        trunc_ln680_2_reg_1616 <= trunc_ln680_2_fu_1008_p1;
        trunc_ln680_reg_1606 <= trunc_ln680_fu_998_p1;
    end
end
...
always @ (*) begin
    if ((grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd0) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_0_ap_vld = 1'b1;
    end else begin
        dist_0_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_1_ap_vld = 1'b1;
    end else begin
        dist_1_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd2) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_2_ap_vld = 1'b1;
    end else begin
        dist_2_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd3) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_3_ap_vld = 1'b1;
    end else begin
        dist_3_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd4) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_4_ap_vld = 1'b1;
    end else begin
        dist_4_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd5) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_5_ap_vld = 1'b1;
    end else begin
        dist_5_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd6) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_6_ap_vld = 1'b1;
    end else begin
        dist_6_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd7) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_7_ap_vld = 1'b1;
    end else begin
        dist_7_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if (((trunc_ln680_3_fu_1036_p1 == 4'd8) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_8_ap_vld = 1'b1;
    end else begin
        dist_8_ap_vld = 1'b0;
    end
...
always @ (*) begin
    if ((~(trunc_ln680_3_fu_1036_p1 == 4'd0) & ~(trunc_ln680_3_fu_1036_p1 == 4'd1) & ~(trunc_ln680_3_fu_1036_p1 == 4'd2) & ~(trunc_ln680_3_fu_1036_p1 == 4'd3) & ~(trunc_ln680_3_fu_1036_p1 == 4'd4) & ~(trunc_ln680_3_fu_1036_p1 == 4'd5) & ~(trunc_ln680_3_fu_1036_p1 == 4'd6) & ~(trunc_ln680_3_fu_1036_p1 == 4'd7) & ~(trunc_ln680_3_fu_1036_p1 == 4'd8) & (1'b1 == ap_CS_fsm_state4))) begin
        dist_9_ap_vld = 1'b1;
    end else begin
        dist_9_ap_vld = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign add_ln680_fu_1227_p2 = ($signed(i_fu_226) + $signed(5'd31));
...
assign dist_0 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_1 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_2 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_3 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_4 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_5 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_6 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_7 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_8 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign dist_9 = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_min_value_out;

assign grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start = grp_seq_global_merge_L1_L2_Pipeline_VITIS_LOOP_684_3_fu_750_ap_start_reg;
...
assign trunc_ln680_1_fu_1003_p1 = idx_1_fu_234[3:0];

assign trunc_ln680_2_fu_1008_p1 = idx_fu_230[3:0];

assign trunc_ln680_3_fu_1036_p1 = i_fu_226[3:0];

assign trunc_ln680_fu_998_p1 = idx_2_fu_238[3:0];

assign trunc_ln693_fu_1056_p1 = tmp_fu_1039_p9[3:0];
