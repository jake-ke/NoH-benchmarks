...
// 0x1bc : reserved
// 0x1c0 : Data signal of L3_out_dist
//         bit 31~0 - L3_out_dist[31:0] (Read/Write)
// 0x1c4 : Data signal of L3_out_dist
//         bit 31~0 - L3_out_dist[63:32] (Read/Write)
// 0x1c8 : reserved
// 0x1cc : Data signal of L3_out_id
//         bit 31~0 - L3_out_id[31:0] (Read/Write)
// 0x1d0 : Data signal of L3_out_id
...
localparam
    ...
    ADDR_IN_1_DATA_0        = 9'h01c,
    ADDR_IN_1_DATA_1        = 9'h020,
    ADDR_IN_1_CTRL          = 9'h024,
    ADDR_IN_2_DATA_0        = 9'h028,
    ADDR_IN_2_DATA_1        = 9'h02c,
    ADDR_IN_2_CTRL          = 9'h030,
    ADDR_IN_3_DATA_0        = 9'h034,
    ADDR_IN_3_DATA_1        = 9'h038,
    ADDR_IN_3_CTRL          = 9'h03c,
    ADDR_IN_4_DATA_0        = 9'h040,
    ADDR_IN_4_DATA_1        = 9'h044,
    ADDR_IN_4_CTRL          = 9'h048,
    ADDR_IN_5_DATA_0        = 9'h04c,
    ADDR_IN_5_DATA_1        = 9'h050,
    ADDR_IN_5_CTRL          = 9'h054,
    ADDR_IN_6_DATA_0        = 9'h058,
    ADDR_IN_6_DATA_1        = 9'h05c,
    ADDR_IN_6_CTRL          = 9'h060,
    ADDR_IN_7_DATA_0        = 9'h064,
    ADDR_IN_7_DATA_1        = 9'h068,
    ADDR_IN_7_CTRL          = 9'h06c,
    ADDR_IN_8_DATA_0        = 9'h070,
    ADDR_IN_8_DATA_1        = 9'h074,
    ADDR_IN_8_CTRL          = 9'h078,
    ADDR_IN_9_DATA_0        = 9'h07c,
    ADDR_IN_9_DATA_1        = 9'h080,
    ADDR_IN_9_CTRL          = 9'h084,
    ADDR_IN_10_DATA_0       = 9'h088,
    ADDR_IN_10_DATA_1       = 9'h08c,
    ADDR_IN_10_CTRL         = 9'h090,
    ADDR_IN_11_DATA_0       = 9'h094,
    ADDR_IN_11_DATA_1       = 9'h098,
    ADDR_IN_11_CTRL         = 9'h09c,
    ADDR_IN_12_DATA_0       = 9'h0a0,
    ADDR_IN_12_DATA_1       = 9'h0a4,
    ADDR_IN_12_CTRL         = 9'h0a8,
    ADDR_IN_13_DATA_0       = 9'h0ac,
    ADDR_IN_13_DATA_1       = 9'h0b0,
    ADDR_IN_13_CTRL         = 9'h0b4,
    ADDR_IN_14_DATA_0       = 9'h0b8,
    ADDR_IN_14_DATA_1       = 9'h0bc,
    ADDR_IN_14_CTRL         = 9'h0c0,
    ADDR_IN_15_DATA_0       = 9'h0c4,
    ADDR_IN_15_DATA_1       = 9'h0c8,
    ADDR_IN_15_CTRL         = 9'h0cc,
    ADDR_IN_16_DATA_0       = 9'h0d0,
    ADDR_IN_16_DATA_1       = 9'h0d4,
    ADDR_IN_16_CTRL         = 9'h0d8,
    ADDR_IN_17_DATA_0       = 9'h0dc,
    ADDR_IN_17_DATA_1       = 9'h0e0,
    ADDR_IN_17_CTRL         = 9'h0e4,
    ADDR_IN_18_DATA_0       = 9'h0e8,
    ADDR_IN_18_DATA_1       = 9'h0ec,
    ADDR_IN_18_CTRL         = 9'h0f0,
    ADDR_IN_19_DATA_0       = 9'h0f4,
    ADDR_IN_19_DATA_1       = 9'h0f8,
    ADDR_IN_19_CTRL         = 9'h0fc,
    ADDR_IN_20_DATA_0       = 9'h100,
    ADDR_IN_20_DATA_1       = 9'h104,
    ADDR_IN_20_CTRL         = 9'h108,
    ADDR_IN_21_DATA_0       = 9'h10c,
    ADDR_IN_21_DATA_1       = 9'h110,
    ADDR_IN_21_CTRL         = 9'h114,
    ADDR_IN_22_DATA_0       = 9'h118,
    ADDR_IN_22_DATA_1       = 9'h11c,
    ADDR_IN_22_CTRL         = 9'h120,
    ADDR_IN_23_DATA_0       = 9'h124,
    ADDR_IN_23_DATA_1       = 9'h128,
    ADDR_IN_23_CTRL         = 9'h12c,
    ADDR_IN_24_DATA_0       = 9'h130,
    ADDR_IN_24_DATA_1       = 9'h134,
    ADDR_IN_24_CTRL         = 9'h138,
    ADDR_IN_25_DATA_0       = 9'h13c,
    ADDR_IN_25_DATA_1       = 9'h140,
    ADDR_IN_25_CTRL         = 9'h144,
    ADDR_IN_26_DATA_0       = 9'h148,
    ADDR_IN_26_DATA_1       = 9'h14c,
    ADDR_IN_26_CTRL         = 9'h150,
    ADDR_IN_27_DATA_0       = 9'h154,
    ADDR_IN_27_DATA_1       = 9'h158,
    ADDR_IN_27_CTRL         = 9'h15c,
    ADDR_IN_28_DATA_0       = 9'h160,
    ADDR_IN_28_DATA_1       = 9'h164,
    ADDR_IN_28_CTRL         = 9'h168,
    ADDR_IN_29_DATA_0       = 9'h16c,
    ADDR_IN_29_DATA_1       = 9'h170,
    ADDR_IN_29_CTRL         = 9'h174,
    ADDR_IN_30_DATA_0       = 9'h178,
    ADDR_IN_30_DATA_1       = 9'h17c,
    ADDR_IN_30_CTRL         = 9'h180,
    ADDR_IN_31_DATA_0       = 9'h184,
    ADDR_IN_31_DATA_1       = 9'h188,
    ADDR_IN_31_CTRL         = 9'h18c,
    ADDR_IN_32_DATA_0       = 9'h190,
    ADDR_IN_32_DATA_1       = 9'h194,
    ADDR_IN_32_CTRL         = 9'h198,
    ADDR_IN_33_DATA_0       = 9'h19c,
    ADDR_IN_33_DATA_1       = 9'h1a0,
    ADDR_IN_33_CTRL         = 9'h1a4,
    ADDR_IN_34_DATA_0       = 9'h1a8,
    ADDR_IN_34_DATA_1       = 9'h1ac,
    ADDR_IN_34_CTRL         = 9'h1b0,
    ADDR_IN_35_DATA_0       = 9'h1b4,
    ADDR_IN_35_DATA_1       = 9'h1b8,
    ADDR_IN_35_CTRL         = 9'h1bc,
    ADDR_L3_OUT_DIST_DATA_0 = 9'h1c0,
    ADDR_L3_OUT_DIST_DATA_1 = 9'h1c4,
    ADDR_L3_OUT_DIST_CTRL   = 9'h1c8,
    ADDR_L3_OUT_ID_DATA_0   = 9'h1cc,
    ADDR_L3_OUT_ID_DATA_1   = 9'h1d0,
    ADDR_L3_OUT_ID_CTRL     = 9'h1d4,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
