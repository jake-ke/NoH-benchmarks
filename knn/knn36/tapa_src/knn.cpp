...
void Knn(
  ...
  tapa::streams<pkt, 36, 2> out_dist;
  tapa::streams<id_pkt, 36, 2> out_id;
  tapa::streams<pkt, 12, 2> L1_out_dist;
  tapa::streams<id_pkt, 12, 2> L1_out_id;
  ...
  tapa::task()
    ...
    .invoke( krnl_globalSort_L1_L2, L2_out_dist0, L2_out_id0, L2_out_dist1, L2_out_id1, L2_out_dist2, L2_out_id2, L3_out_dist_stream, L3_out_id_stream )
    .invoke( krnl_globalSort_L3, L3_out_dist_stream, L3_out_id_stream, L2_out_dist3, L2_out_id3, L3_out_dist, L3_out_id );
