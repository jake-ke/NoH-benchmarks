...
module __rs_pipelined_async_mmap_L3_out_dist__m_axi #(
...
wire [(DataWidth - 1):0] __rs_pipelined_m_axi_RDATA;
wire [              0:0] __rs_pipelined_m_axi_RID;
wire                     __rs_pipelined_m_axi_RLAST;
wire                     __rs_pipelined_m_axi_RREADY;
wire [              1:0] __rs_pipelined_m_axi_RRESP;
wire                     __rs_pipelined_m_axi_RVALID;
...
async_mmap #(
    ...
    .m_axi_RDATA        (__rs_pipelined_m_axi_RDATA),
    .m_axi_RID          (__rs_pipelined_m_axi_RID),
    .m_axi_RLAST        (__rs_pipelined_m_axi_RLAST),
    .m_axi_RREADY       (__rs_pipelined_m_axi_RREADY),
    .m_axi_RRESP        (__rs_pipelined_m_axi_RRESP),
    .m_axi_RVALID       (__rs_pipelined_m_axi_RVALID),
    ...
    .write_data_full_n  (write_data_full_n),
    .write_data_write   (write_data_write),
...
__rs_hs_pipeline_2 #(
    .BODY_LEVEL                      (2),
    .DATA_WIDTH                      (( ( ( ( DataWidth - 1 ) - ( 0 ) + 1 ) ) + ( 1 ) + ( 1 ) + ( 2 ) + 0 )),
    .DEPTH                           (8),
    ...
    .clk        (clk),
    .if_din     ({ m_axi_RDATA , m_axi_RID , m_axi_RLAST , m_axi_RRESP }),
    .if_dout    ({ __rs_pipelined_m_axi_RDATA , __rs_pipelined_m_axi_RID , __rs_pipelined_m_axi_RLAST , __rs_pipelined_m_axi_RRESP }),
    .if_empty_n (__rs_pipelined_m_axi_RVALID),
    .if_full_n  (m_axi_RREADY),
    .if_read    (__rs_pipelined_m_axi_RREADY),
    .if_write   (m_axi_RVALID),
    .reset      (1'b0)
);

endmodule  // __rs_pipelined_async_mmap_L3_out_dist__m_axi