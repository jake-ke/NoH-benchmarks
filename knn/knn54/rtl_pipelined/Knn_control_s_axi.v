...
// 0x228 : reserved
// 0x22c : Data signal of in_45
//         bit 31~0 - in_45[31:0] (Read/Write)
// 0x230 : Data signal of in_45
//         bit 31~0 - in_45[63:32] (Read/Write)
// 0x234 : reserved
// 0x238 : Data signal of in_46
//         bit 31~0 - in_46[31:0] (Read/Write)
// 0x23c : Data signal of in_46
//         bit 31~0 - in_46[63:32] (Read/Write)
// 0x240 : reserved
// 0x244 : Data signal of in_47
//         bit 31~0 - in_47[31:0] (Read/Write)
// 0x248 : Data signal of in_47
//         bit 31~0 - in_47[63:32] (Read/Write)
// 0x24c : reserved
// 0x250 : Data signal of in_48
//         bit 31~0 - in_48[31:0] (Read/Write)
// 0x254 : Data signal of in_48
//         bit 31~0 - in_48[63:32] (Read/Write)
// 0x258 : reserved
// 0x25c : Data signal of in_49
//         bit 31~0 - in_49[31:0] (Read/Write)
// 0x260 : Data signal of in_49
//         bit 31~0 - in_49[63:32] (Read/Write)
// 0x264 : reserved
// 0x268 : Data signal of in_50
//         bit 31~0 - in_50[31:0] (Read/Write)
// 0x26c : Data signal of in_50
//         bit 31~0 - in_50[63:32] (Read/Write)
// 0x270 : reserved
// 0x274 : Data signal of in_51
//         bit 31~0 - in_51[31:0] (Read/Write)
// 0x278 : Data signal of in_51
//         bit 31~0 - in_51[63:32] (Read/Write)
// 0x27c : reserved
// 0x280 : Data signal of in_52
//         bit 31~0 - in_52[31:0] (Read/Write)
// 0x284 : Data signal of in_52
//         bit 31~0 - in_52[63:32] (Read/Write)
// 0x288 : reserved
// 0x28c : Data signal of in_53
//         bit 31~0 - in_53[31:0] (Read/Write)
// 0x290 : Data signal of in_53
//         bit 31~0 - in_53[63:32] (Read/Write)
// 0x294 : reserved
// 0x298 : Data signal of L4_out_dist
//         bit 31~0 - L4_out_dist[31:0] (Read/Write)
// 0x29c : Data signal of L4_out_dist
//         bit 31~0 - L4_out_dist[63:32] (Read/Write)
// 0x2a0 : reserved
// 0x2a4 : Data signal of L4_out_id
//         bit 31~0 - L4_out_id[31:0] (Read/Write)
// 0x2a8 : Data signal of L4_out_id
//         bit 31~0 - L4_out_id[63:32] (Read/Write)
// 0x2ac : reserved
...
localparam
    ...
    ADDR_IN_45_DATA_0       = 10'h22c,
    ADDR_IN_45_DATA_1       = 10'h230,
    ADDR_IN_45_CTRL         = 10'h234,
    ADDR_IN_46_DATA_0       = 10'h238,
    ADDR_IN_46_DATA_1       = 10'h23c,
    ADDR_IN_46_CTRL         = 10'h240,
    ADDR_IN_47_DATA_0       = 10'h244,
    ADDR_IN_47_DATA_1       = 10'h248,
    ADDR_IN_47_CTRL         = 10'h24c,
    ADDR_IN_48_DATA_0       = 10'h250,
    ADDR_IN_48_DATA_1       = 10'h254,
    ADDR_IN_48_CTRL         = 10'h258,
    ADDR_IN_49_DATA_0       = 10'h25c,
    ADDR_IN_49_DATA_1       = 10'h260,
    ADDR_IN_49_CTRL         = 10'h264,
    ADDR_IN_50_DATA_0       = 10'h268,
    ADDR_IN_50_DATA_1       = 10'h26c,
    ADDR_IN_50_CTRL         = 10'h270,
    ADDR_IN_51_DATA_0       = 10'h274,
    ADDR_IN_51_DATA_1       = 10'h278,
    ADDR_IN_51_CTRL         = 10'h27c,
    ADDR_IN_52_DATA_0       = 10'h280,
    ADDR_IN_52_DATA_1       = 10'h284,
    ADDR_IN_52_CTRL         = 10'h288,
    ADDR_IN_53_DATA_0       = 10'h28c,
    ADDR_IN_53_DATA_1       = 10'h290,
    ADDR_IN_53_CTRL         = 10'h294,
    ADDR_L4_OUT_DIST_DATA_0 = 10'h298,
    ADDR_L4_OUT_DIST_DATA_1 = 10'h29c,
    ADDR_L4_OUT_DIST_CTRL   = 10'h2a0,
    ADDR_L4_OUT_ID_DATA_0   = 10'h2a4,
    ADDR_L4_OUT_ID_DATA_1   = 10'h2a8,
    ADDR_L4_OUT_ID_CTRL     = 10'h2ac,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [63:0]                   int_in_45 = 'b0;
    reg  [63:0]                   int_in_46 = 'b0;
    reg  [63:0]                   int_in_47 = 'b0;
    reg  [63:0]                   int_in_48 = 'b0;
    reg  [63:0]                   int_in_49 = 'b0;
    reg  [63:0]                   int_in_50 = 'b0;
    reg  [63:0]                   int_in_51 = 'b0;
    reg  [63:0]                   int_in_52 = 'b0;
    reg  [63:0]                   int_in_53 = 'b0;
    reg  [63:0]                   int_L4_out_dist = 'b0;
    reg  [63:0]                   int_L4_out_id = 'b0;
//------------------------Instantiation------------------
//------------------------AXI write fsm------------------
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IN_45_DATA_0: begin
                    rdata <= int_in_45[31:0];
                end
                ADDR_IN_45_DATA_1: begin
                    rdata <= int_in_45[63:32];
                end
                ADDR_IN_46_DATA_0: begin
                    rdata <= int_in_46[31:0];
                end
                ADDR_IN_46_DATA_1: begin
                    rdata <= int_in_46[63:32];
                end
                ADDR_IN_47_DATA_0: begin
                    rdata <= int_in_47[31:0];
                end
                ADDR_IN_47_DATA_1: begin
                    rdata <= int_in_47[63:32];
                end
                ADDR_IN_48_DATA_0: begin
                    rdata <= int_in_48[31:0];
                end
                ADDR_IN_48_DATA_1: begin
                    rdata <= int_in_48[63:32];
                end
                ADDR_IN_49_DATA_0: begin
                    rdata <= int_in_49[31:0];
                end
                ADDR_IN_49_DATA_1: begin
                    rdata <= int_in_49[63:32];
                end
                ADDR_IN_50_DATA_0: begin
                    rdata <= int_in_50[31:0];
                end
                ADDR_IN_50_DATA_1: begin
                    rdata <= int_in_50[63:32];
                end
                ADDR_IN_51_DATA_0: begin
                    rdata <= int_in_51[31:0];
                end
                ADDR_IN_51_DATA_1: begin
                    rdata <= int_in_51[63:32];
                end
                ADDR_IN_52_DATA_0: begin
                    rdata <= int_in_52[31:0];
                end
                ADDR_IN_52_DATA_1: begin
                    rdata <= int_in_52[63:32];
                end
                ADDR_IN_53_DATA_0: begin
                    rdata <= int_in_53[31:0];
                end
                ADDR_IN_53_DATA_1: begin
                    rdata <= int_in_53[63:32];
                end
                ADDR_L4_OUT_DIST_DATA_0: begin
                    rdata <= int_L4_out_dist[31:0];
                end
                ADDR_L4_OUT_DIST_DATA_1: begin
                    rdata <= int_L4_out_dist[63:32];
                end
                ADDR_L4_OUT_ID_DATA_0: begin
                    rdata <= int_L4_out_id[31:0];
                end
                ADDR_L4_OUT_ID_DATA_1: begin
                    rdata <= int_L4_out_id[63:32];
                end
            endcase
        end
    end
...
assign in_45             = int_in_45;
assign in_46             = int_in_46;
assign in_47             = int_in_47;
assign in_48             = int_in_48;
assign in_49             = int_in_49;
assign in_50             = int_in_50;
assign in_51             = int_in_51;
assign in_52             = int_in_52;
assign in_53             = int_in_53;
assign L4_out_dist       = int_L4_out_dist;
assign L4_out_id         = int_L4_out_id;
// int_interrupt
always @(posedge ACLK) begin
    if (ARESET)
        int_interrupt <= 1'b0;
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_45_DATA_0)
            int_in_45[31:0] <= (WDATA[31:0] & wmask) | (int_in_45[31:0] & ~wmask);
    end
end
// int_in_45[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_45_DATA_1)
            int_in_45[63:32] <= (WDATA[31:0] & wmask) | (int_in_45[63:32] & ~wmask);
    end
end
// int_in_46[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_46_DATA_0)
            int_in_46[31:0] <= (WDATA[31:0] & wmask) | (int_in_46[31:0] & ~wmask);
    end
end
// int_in_46[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_46_DATA_1)
            int_in_46[63:32] <= (WDATA[31:0] & wmask) | (int_in_46[63:32] & ~wmask);
    end
end
// int_in_47[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_47_DATA_0)
            int_in_47[31:0] <= (WDATA[31:0] & wmask) | (int_in_47[31:0] & ~wmask);
    end
end
// int_in_47[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_47_DATA_1)
            int_in_47[63:32] <= (WDATA[31:0] & wmask) | (int_in_47[63:32] & ~wmask);
    end
end
// int_in_48[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_48_DATA_0)
            int_in_48[31:0] <= (WDATA[31:0] & wmask) | (int_in_48[31:0] & ~wmask);
    end
end
// int_in_48[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_48_DATA_1)
            int_in_48[63:32] <= (WDATA[31:0] & wmask) | (int_in_48[63:32] & ~wmask);
    end
end
// int_in_49[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_49_DATA_0)
            int_in_49[31:0] <= (WDATA[31:0] & wmask) | (int_in_49[31:0] & ~wmask);
    end
end
// int_in_49[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_49_DATA_1)
            int_in_49[63:32] <= (WDATA[31:0] & wmask) | (int_in_49[63:32] & ~wmask);
    end
end
// int_in_50[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_50_DATA_0)
            int_in_50[31:0] <= (WDATA[31:0] & wmask) | (int_in_50[31:0] & ~wmask);
    end
end
// int_in_50[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_50_DATA_1)
            int_in_50[63:32] <= (WDATA[31:0] & wmask) | (int_in_50[63:32] & ~wmask);
    end
end
// int_in_51[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_51_DATA_0)
            int_in_51[31:0] <= (WDATA[31:0] & wmask) | (int_in_51[31:0] & ~wmask);
    end
end
// int_in_51[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_51_DATA_1)
            int_in_51[63:32] <= (WDATA[31:0] & wmask) | (int_in_51[63:32] & ~wmask);
    end
end
// int_in_52[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_52_DATA_0)
            int_in_52[31:0] <= (WDATA[31:0] & wmask) | (int_in_52[31:0] & ~wmask);
    end
end
// int_in_52[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_52_DATA_1)
            int_in_52[63:32] <= (WDATA[31:0] & wmask) | (int_in_52[63:32] & ~wmask);
    end
end
// int_in_53[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_53_DATA_0)
            int_in_53[31:0] <= (WDATA[31:0] & wmask) | (int_in_53[31:0] & ~wmask);
    end
end
// int_in_53[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_53_DATA_1)
            int_in_53[63:32] <= (WDATA[31:0] & wmask) | (int_in_53[63:32] & ~wmask);
    end
end
// int_L4_out_dist[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_L4_out_dist[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_L4_OUT_DIST_DATA_0)
            int_L4_out_dist[31:0] <= (WDATA[31:0] & wmask) | (int_L4_out_dist[31:0] & ~wmask);
    end
end
// int_L4_out_dist[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        int_L4_out_dist[63:32] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_L4_OUT_DIST_DATA_1)
            int_L4_out_dist[63:32] <= (WDATA[31:0] & wmask) | (int_L4_out_dist[63:32] & ~wmask);
    end
end
// int_L4_out_id[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_L4_out_id[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_L4_OUT_ID_DATA_0)
            int_L4_out_id[31:0] <= (WDATA[31:0] & wmask) | (int_L4_out_id[31:0] & ~wmask);
    end
end
// int_L4_out_id[63:32]
always @(posedge ACLK) begin
    if (ARESET)
        int_L4_out_id[63:32] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_L4_OUT_ID_DATA_1)
            int_L4_out_id[63:32] <= (WDATA[31:0] & wmask) | (int_L4_out_id[63:32] & ~wmask);
    end
end
