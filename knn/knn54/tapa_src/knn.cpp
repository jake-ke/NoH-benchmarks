...
void krnl_partialKnn_wrapper_45(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<45>(searchSpace_0, start_id_0, out_dist, out_id);
}

void krnl_partialKnn_wrapper_46(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<46>(searchSpace_0, start_id_0, out_dist, out_id);
}

void krnl_partialKnn_wrapper_47(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<47>(searchSpace_0, start_id_0, out_dist, out_id);
}


void krnl_partialKnn_wrapper_48(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<48>(searchSpace_0, start_id_0, out_dist, out_id);
}


void krnl_partialKnn_wrapper_49(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<49>(searchSpace_0, start_id_0, out_dist, out_id);
}

void krnl_partialKnn_wrapper_50(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<50>(searchSpace_0, start_id_0, out_dist, out_id);
}


void krnl_partialKnn_wrapper_51(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<51>(searchSpace_0, start_id_0, out_dist, out_id);
}


void krnl_partialKnn_wrapper_52(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<52>(searchSpace_0, start_id_0, out_dist, out_id);
}


void krnl_partialKnn_wrapper_53(
    tapa::async_mmap<INTERFACE_WIDTH>& searchSpace_0,
    int start_id_0,
    tapa::ostream<pkt> &out_dist,
    tapa::ostream<id_pkt> &out_id)
{
  krnl_partialKnn<53>(searchSpace_0, start_id_0, out_dist, out_id);
}
...
void Knn(
  ...
  tapa::mmap<INTERFACE_WIDTH> in_45,
  tapa::mmap<INTERFACE_WIDTH> in_46,
  tapa::mmap<INTERFACE_WIDTH> in_47,
  tapa::mmap<INTERFACE_WIDTH> in_48,
  tapa::mmap<INTERFACE_WIDTH> in_49,
  tapa::mmap<INTERFACE_WIDTH> in_50,
  tapa::mmap<INTERFACE_WIDTH> in_51,
  tapa::mmap<INTERFACE_WIDTH> in_52,
  tapa::mmap<INTERFACE_WIDTH> in_53,
  tapa::mmap<float> L4_out_dist,
  tapa::mmap<int> L4_out_id
) {

  tapa::streams<pkt, 54, 2> out_dist;
  tapa::streams<id_pkt, 54, 2> out_id;
  tapa::streams<pkt, 18, 2> L1_out_dist;
  tapa::streams<id_pkt, 18, 2> L1_out_id;
  ...
  tapa::stream<pkt, 2> L2_out_dist5;
  ...
  tapa::stream<id_pkt, 2> L2_out_id5;
  tapa::stream<pkt, 2> L3_out_dist0;
  tapa::stream<id_pkt, 2> L3_out_id0;
  tapa::stream<pkt, 2> L3_out_dist1;
  tapa::stream<id_pkt, 2> L3_out_id1;
  ...
  tapa::task()
    ...
    .invoke( krnl_partialKnn_wrapper_45  , in_45, NUM_SP_PTS_PADDED*45, out_dist[45], out_id[45] )
    .invoke( krnl_partialKnn_wrapper_46  , in_46, NUM_SP_PTS_PADDED*46, out_dist[46], out_id[46] )
    .invoke( krnl_partialKnn_wrapper_47  , in_47, NUM_SP_PTS_PADDED*47, out_dist[47], out_id[47] )
    .invoke( krnl_partialKnn_wrapper_48  , in_48, NUM_SP_PTS_PADDED*48, out_dist[48], out_id[48]  )
    .invoke( krnl_partialKnn_wrapper_49  , in_49, NUM_SP_PTS_PADDED*49, out_dist[49], out_id[49]  )
    .invoke( krnl_partialKnn_wrapper_50  , in_50, NUM_SP_PTS_PADDED*50, out_dist[50], out_id[50] )
    .invoke( krnl_partialKnn_wrapper_51  , in_51, NUM_SP_PTS_PADDED*51, out_dist[51], out_id[51] )
    .invoke( krnl_partialKnn_wrapper_52  , in_52, NUM_SP_PTS_PADDED*52, out_dist[52], out_id[52] )
    .invoke( krnl_partialKnn_wrapper_53  , in_53, NUM_SP_PTS_PADDED*53, out_dist[53], out_id[53] )
    ...
    .invoke( krnl_globalSort_L1_L2, out_dist[45], out_id[45], out_dist[46], out_id[46], out_dist[47], out_id[47], L1_out_dist[15], L1_out_id[15] )
    .invoke( krnl_globalSort_L1_L2, out_dist[48], out_id[48], out_dist[49], out_id[49], out_dist[50], out_id[50], L1_out_dist[16], L1_out_id[16] )
    .invoke( krnl_globalSort_L1_L2, out_dist[51], out_id[51], out_dist[52], out_id[52], out_dist[53], out_id[53], L1_out_dist[17], L1_out_id[17] )
    ...
    .invoke( krnl_globalSort_L1_L2, L1_out_dist[15], L1_out_id[15], L1_out_dist[16], L1_out_id[16], L1_out_dist[17], L1_out_id[17], L2_out_dist5, L2_out_id5 )
    .invoke( krnl_globalSort_L1_L2, L2_out_dist0, L2_out_id0, L2_out_dist1, L2_out_id1, L2_out_dist2, L2_out_id2, L3_out_dist0, L3_out_id0 )
    .invoke( krnl_globalSort_L1_L2, L2_out_dist3, L2_out_id3, L2_out_dist4, L2_out_id4, L2_out_dist5, L2_out_id5, L3_out_dist1, L3_out_id1 )
    .invoke( krnl_globalSort_L3, L3_out_dist0, L3_out_id0, L3_out_dist1, L3_out_id1, L4_out_dist, L4_out_id);
