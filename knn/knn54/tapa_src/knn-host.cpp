...
void Knn(
  ...
  tapa::mmap<INTERFACE_WIDTH> in_18, tapa::mmap<INTERFACE_WIDTH> in_19,
  tapa::mmap<INTERFACE_WIDTH> in_20, tapa::mmap<INTERFACE_WIDTH> in_21,
  tapa::mmap<INTERFACE_WIDTH> in_22, tapa::mmap<INTERFACE_WIDTH> in_23,
  tapa::mmap<INTERFACE_WIDTH> in_24, tapa::mmap<INTERFACE_WIDTH> in_25,
  tapa::mmap<INTERFACE_WIDTH> in_26, tapa::mmap<INTERFACE_WIDTH> in_27,
  tapa::mmap<INTERFACE_WIDTH> in_28, tapa::mmap<INTERFACE_WIDTH> in_29,
  tapa::mmap<INTERFACE_WIDTH> in_30, tapa::mmap<INTERFACE_WIDTH> in_31,
  tapa::mmap<INTERFACE_WIDTH> in_32, tapa::mmap<INTERFACE_WIDTH> in_33,
  tapa::mmap<INTERFACE_WIDTH> in_34, tapa::mmap<INTERFACE_WIDTH> in_35,
  tapa::mmap<INTERFACE_WIDTH> in_36, tapa::mmap<INTERFACE_WIDTH> in_37,
  tapa::mmap<INTERFACE_WIDTH> in_38, tapa::mmap<INTERFACE_WIDTH> in_39,
  tapa::mmap<INTERFACE_WIDTH> in_40, tapa::mmap<INTERFACE_WIDTH> in_41,
  tapa::mmap<INTERFACE_WIDTH> in_42, tapa::mmap<INTERFACE_WIDTH> in_43,
  tapa::mmap<INTERFACE_WIDTH> in_44, tapa::mmap<INTERFACE_WIDTH> in_45,
  tapa::mmap<INTERFACE_WIDTH> in_46, tapa::mmap<INTERFACE_WIDTH> in_47,
  tapa::mmap<INTERFACE_WIDTH> in_48, tapa::mmap<INTERFACE_WIDTH> in_49,
  tapa::mmap<INTERFACE_WIDTH> in_50, tapa::mmap<INTERFACE_WIDTH> in_51,
  tapa::mmap<INTERFACE_WIDTH> in_52, tapa::mmap<INTERFACE_WIDTH> in_53,
  tapa::mmap<float> L4_out_dist, tapa::mmap<int> L4_out_id);
...
int main(int argc, char* argv[]) {
  gflags::ParseCommandLineFlags(&argc, &argv, /*remove_flags=*/true);
	...
	// generate input data
    int num_pe = 54; //user-defined - temp hack
	...
	tapa::invoke(Knn, FLAGS_bitstream,
				 ...
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[18]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[19]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[20]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[21]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[22]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[23]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[24]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[25]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[26]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[27]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[28]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[29]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[30]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[31]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[32]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[33]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[34]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[35]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[36]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[37]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[38]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[39]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[40]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[41]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[42]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[43]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[44]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[45]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[46]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[47]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[48]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[49]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[50]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[51]),
				 tapa::read_only_mmap<INTERFACE_WIDTH>(in[52]), tapa::read_only_mmap<INTERFACE_WIDTH>(in[53]),
