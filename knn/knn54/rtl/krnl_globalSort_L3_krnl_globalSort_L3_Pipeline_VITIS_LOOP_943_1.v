...
module krnl_globalSort_L3_krnl_globalSort_L3_Pipeline_VITIS_LOOP_943_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [3:0] i_fu_90;
wire   [3:0] add_ln943_fu_350_p2;
wire    ap_loop_init;
reg   [3:0] ap_sig_allocacmp_i_2;
reg   [31:0] empty_fu_94;
wire   [31:0] bitcast_ln947_fu_380_p1;
reg   [31:0] empty_19_fu_98;
wire   [31:0] bitcast_ln950_fu_391_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln943_fu_356_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_90 <= add_ln943_fu_350_p2;
...
always @ (posedge ap_clk) begin
    if ((~(i_2_reg_946 == 4'd0) & ~(i_2_reg_946 == 4'd1) & ~(i_2_reg_946 == 4'd2) & ~(i_2_reg_946 == 4'd3) & ~(i_2_reg_946 == 4'd4) & ~(i_2_reg_946 == 4'd5) & ~(i_2_reg_946 == 4'd6) & ~(i_2_reg_946 == 4'd7) & ~(i_2_reg_946 == 4'd8) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        empty_36_fu_166 <= bitcast_ln947_fu_380_p1;
        empty_37_fu_170 <= bitcast_ln950_fu_391_p1;
    end
end
...
always @ (*) begin
    if (((icmp_ln943_fu_356_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln943_fu_356_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        p_out10_ap_vld = 1'b1;
    end else begin
        p_out10_ap_vld = 1'b0;
    end
...
assign add_ln943_fu_350_p2 = (ap_sig_allocacmp_i_2 + 4'd1);
...
assign bitcast_ln947_fu_380_p1 = v0_data_fu_376_p1;

assign bitcast_ln950_fu_391_p1 = v1_data_fu_387_p1;

assign icmp_ln943_fu_356_p2 = ((ap_sig_allocacmp_i_2 == 4'd10) ? 1'b1 : 1'b0);
...
endmodule //krnl_globalSort_L3_krnl_globalSort_L3_Pipeline_VITIS_LOOP_943_1
